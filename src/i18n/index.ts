...
export function localizeMetadata(item: PrototypeMetadata): PrototypeMetadata {
  const prefixById: Record<string, string> = { "cellular-material": "cellular", "behavior-tree-utility": "decision", "rollback-netcode": "rollback", "bouncing-ball": "bouncing", "verlet-rope": "rope", "flow-field": "flow", "sdf-playground": "sdf", "crowd-steering": "crowd", "constraint-generation": "constraint" };
